...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({
  ...
  return (
    <div className="mt-4">
      <div className={`alert position-relative ${confidenceScore && confidenceScore > 85
        ...
        <div className="d-flex align-items-center mb-3">
          <i className={`bi bi-check-circle-fill me-3 fs-3 ${confidenceScore && confidenceScore > 85
              ? 'text-success'
              : confidenceScore && confidenceScore > 70
                ? 'text-warning'
                : 'text-danger'
        ...
        {confidenceScore && (
          <div className="mt-3">
            ...
            <div className="progress" style={{ height: "0.5rem" }}>
              <div className={`progress-bar ${confidenceScore > 85
                  ? 'bg-success'
                  : confidenceScore > 70
                    ? 'bg-warning'
                    : 'bg-danger'
